...
def salary():
    ...
    def iniciar_sesion(nombre_usuario):
        ...
        if nombre_usuario in usuarios_registrados and usuarios_registrados[nombre_usuario]["contraseña"] == contraseña:
            ...
            print("\n" + f"Inicio de sesión exitoso como {tipo_usuario}.\n")
    ...
    def listar_empleados():
        for empleado in empleados:
            print("\n" + f"ID: {empleado['id']}, Nombre: {empleado['nombre']}, Cargo: {empleado['cargo']}")
    ...
    def imprimir_colilla_pago():
        for empleado, salario_neto in colillas_pago:
            print("\n" + f"ID: {empleado['id']}, Nombre: {empleado['nombre']}, Cargo: {empleado['cargo']}, Salario Neto: {salario_neto}")

    def buscar_empleado_por_id(id):
        for empleado in empleados:
            if empleado['id'] == id:
                print("\n" + f"ID: {empleado['id']}, Nombre: {empleado['nombre']}, Cargo: {empleado['cargo']}, Salario Neto: {empleado['salario_neto']}")
                return
